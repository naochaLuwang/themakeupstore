...
export function ProductCard({ product }: { product: any }) {
    ...
    // Find default variant or fall back to first one, otherwise use base product
        ...
        <div className="group relative flex flex-col">
            ...
            {!isOutOfStock && (
                <button
                    ...
                    className="absolute bottom-[120px] right-4 z-30 p-3.5 rounded-full bg-black text-white shadow-2xl translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 md:flex hidden hover:scale-110 active:scale-95"
                >
            ...
            {!isOutOfStock && (
                <button
                    onClick={handleQuickAdd}
                    className="md:hidden mt-4 w-full py-4 bg-slate-900 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl active:scale-[0.97] transition-all shadow-lg shadow-slate-200"
                >
                    Add to Bag
                </button>
            )}
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="text-left space-y-0.5">
                                                    ...
                                                    <p className="text-[10px] text-slate-500 font-medium italic">₹{vPrice.toLocaleString()}</p>
                                                    {vStock < 5 && vStock > 0 && (
                                                        <p className="text-[8px] font-bold text-orange-600 uppercase">Only {vStock} left</p>
                                                    )}
                                                </div>
                                            </div>
