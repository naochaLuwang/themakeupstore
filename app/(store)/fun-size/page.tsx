    ...
    return (
        <div className="min-h-screen bg-white text-zinc-900 pb-20 pt-16">
            ...
            <main className="max-w-7xl mx-auto px-6 pb-20">
                <Breadcrumbs items={[{ label: "Fun Size", href: "/fun-size" }]} />
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    <div>
                        <h1 className="text-4xl font-black uppercase tracking-tighter italic">Fun Size</h1>
                        <p className="text-[10px] text-zinc-400 uppercase tracking-widest mt-2">Mini & travel-size picks at pocket-friendly prices</p>
                    </div>
                ...
                {!loading && filteredProducts.length === 0 && (
                    <div className="text-center py-20">
                        <p className="text-sm text-zinc-400">No fun size products available yet.</p>
                    </div>
                )}
