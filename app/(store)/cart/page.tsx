        ...
        <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6">
            ...
            >
                ...
                <div className="relative inline-block">
                    <div className="w-24 h-24 rounded-full border border-zinc-100 flex items-center justify-center mx-auto">
                        <ShoppingBag className="w-6 h-6 text-zinc-300 stroke-[1]" />
                    </div>
                    <motion.div
                        animate={{ scale: [1, 1.1, 1], opacity: [0.3, 0.6, 0.3] }}
                        transition={{ duration: 4, repeat: Infinity }}
                        className="absolute inset-0 rounded-full bg-zinc-50 -z-10"
                    />
                </div>

                {/* Editorial Text */}
                <div className="space-y-4">
                    {/* <h1 className="text-[10px] font-black uppercase tracking-[0.5em] text-zinc-400">Your Archive</h1> */}
                    <p className="text-3xl font-serif italic tracking-tight text-zinc-900 leading-tight">
                        Your bag is currently empty.
                    </p>
                    <p className="text-[11px] text-zinc-400 uppercase tracking-widest leading-relaxed max-w-[280px] mx-auto">
                        Discover our latest arrivals and timeless staples to begin your collection.
                    </p>
                </div>

                {/* Navigation Actions */}
                <div className="flex flex-col gap-3 pt-4">
                    <Button asChild className="h-14 bg-zinc-900 text-white rounded-none text-[10px] font-black uppercase tracking-[0.3em] hover:bg-black transition-all">
                        <Link href="/shop">Explore Collections</Link>
                    </Button>
                    <Link
                        href="/new-arrivals"
                        className="group flex items-center justify-center gap-2 text-[9px] font-black uppercase tracking-[0.2em] text-zinc-400 hover:text-zinc-900 transition-colors py-4"
                    >
                        View New Arrivals
                ...
                <div className="flex items-center justify-center gap-4 pt-10">
                    ...
                    <span className="text-[8px] font-bold text-zinc-300 uppercase tracking-widest italic">EST. 2024</span>
                    <div className="h-[1px] w-8 bg-zinc-100" />
                </div>
            </motion.div>
        </div>
