...
// import { Loader2, ArrowLeft, AlertCircle, SlidersHorizontal } from "lucide-react"
...
//                 // 2. Fetch Product IDs from the Junction Table (product_categories)
...
//                 // 3. Build a smart query: 
//                 // Fetch products that match the direct category_id OR are in the junction table list
//                 let query = supabase
//                     .from('products')
...
//                     // Logic: (category_id = X OR id IN (ids from junction))
...
//                     <Link href="/exclusive" className="group flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-900 transition-colors">
//                         <ArrowLeft className="w-4 h-4 transition-transform group-hover:-translate-x-1" />
//                         Back to Hub
//                     </Link>
//                     <div className="h-10 px-4 rounded-full bg-slate-50 border border-slate-100 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
...
//                         <p className="text-xs text-rose-600/80 font-medium uppercase tracking-widest leading-relaxed">
//                             {error}
//                         </p>
//                     </div>
//                 ) : (
...
//                                 <span className="text-[10px] font-black uppercase tracking-widest px-3 py-1 bg-slate-900 text-white rounded-md">
//                                     Segment
//                                 </span>
