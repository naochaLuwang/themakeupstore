...
export default function BrandsPage() {
    ...
    return (
        <Skeleton name="brands" loading={loading} fallback={
            <div className="min-h-screen bg-white">
                <div className="max-w-6xl mx-auto px-5 pt-2 pb-20">
                    ...
                    <div className="h-11 w-full bg-slate-100 rounded-lg animate-pulse mb-7" />
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {[...Array(9)].map((_, i) => <div key={i} className="aspect-square bg-slate-100 rounded animate-pulse" />)}
                    </div>
                </div>
            </div>
        }>
